...
st.caption("Monte Carlo simulation using discrete ladder-point outcomes. Developed by Dimitri Perrin. Read about it here: https://dimitriperrin.substack.com/p/a-tool-to-look-at-super-rugby-ladder")
